...
vamos a crear una carpeta aparte con el nombre test( ya que en esta carpeta haremos las pruebas) y vamos a repetir el paso 2, es decir vamos a crear un documento que se llame test_main y le agregamos el mismo documento para que se convierta en un paquete.
...
**paso 6:**
ahora abrimos la consola/terminal y ejecutamos pytest, una vez ejecutado el pytest lo que hace es detectar todos los archivos de prueba y te dice las pruebas que pasaron y las que no. ( si agregas -v al comando pytest te da un resultado mas detallado de todas las pruebas)

![56c7d3bd-1c8e-4c33-a776-b2caa250438c](https://github.com/cristTianDeMartino/PRUEBAS_UNITARIAS/assets/142451429/2b913ff1-ec9d-4b31-bbd3-178d87291da4)
